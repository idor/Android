...
# CFLAGS += -DUSE_KERNEL_HEADERS -I/usrc/linux/include

include $(LOCAL_PATH)/hostapd/config-android
...
include $(LOCAL_PATH)/src/drivers/drivers.mak
OBJS += $(DRV_AP_OBJS)
...
LOCAL_SHARED_LIBRARIES := libcrypto libnl libssl
LOCAL_MODULE := hostapd_bin
LOCAL_MODULE_TAGS := optional
include $(BUILD_EXECUTABLE)

# remove the .config definitions to not interfere with other projects (wpa_supplicant)
include $(LOCAL_PATH)/hostapd/deconfig-android

##### hostapd_cli ######

include $(CLEAR_VARS)

OBJS_c = hostapd/hostapd_cli.o src/common/wpa_ctrl.o src/utils/os_$(CONFIG_OS).o
ifdef CONFIG_WPA_TRACE
OBJS_c += src/utils/trace.o
OBJS_c += src/utils/wpa_debug.o
endif

LOCAL_SRC_FILES := $(OBJS_c:%.o=%.c)
